...
const dark: Theme = {
  ...
  iff: {
    ...
    palette: {
      ...
      blue:   { current: '#0078d4', new: '#dbeafe', changing: '#1e3a8a', decommissioned: '#585b70' },
      red:    { current: '#dc2626', new: '#fecaca', changing: '#991b1b', decommissioned: '#585b70' },
      orange: { current: '#f97316', new: '#ffedd5', changing: '#c2410c', decommissioned: '#585b70' },
      purple: { current: '#6e2382', new: '#f3e8ff', changing: '#23195a', decommissioned: '#585b70' }, // Violet base, Lilac light, Indigo deep
      yellow: { current: '#fdbb31', new: '#fef9c3', changing: '#ca8a04', decommissioned: '#585b70' },
      teal:   { current: '#14b8a6', new: '#ccfbf1', changing: '#0f766e', decommissioned: '#585b70' },
      // Non-updated legacy colors
...
const light: Theme = {
  ...
  id: {
    ...
    glow:                 false,
    palette: {
      green:  { current: '#10b981', new: '#34d399', changing: '#10b981', decommissioned: '#94a3b8' },
      blue:   { current: '#4393DD', new: '#87BFF3', changing: '#4393DD', decommissioned: '#94a3b8' },
      red:    { current: '#D2517F', new: '#EA99B6', changing: '#D2517F', decommissioned: '#94a3b8' },
      orange: { current: '#F18F47', new: '#FABA8A', changing: '#F18F47', decommissioned: '#94a3b8' },
      purple: { current: '#8F70D1', new: '#C1A2F3', changing: '#8F70D1', decommissioned: '#94a3b8' },
      yellow: { current: '#FDC659', new: '#FFDA90', changing: '#FDC659', decommissioned: '#94a3b8' },
      teal:   { current: '#36BCAB', new: '#85D7CB', changing: '#36BCAB', decommissioned: '#94a3b8' },
      cyan:   { current: '#5BB7CF', new: '#A0D5E5', changing: '#5BB7CF', decommissioned: '#94a3b8' },
      pink:   { current: '#DA6FB0', new: '#EFB1D2', changing: '#DA6FB0', decommissioned: '#94a3b8' },
      grey:   { current: '#8C95A7', new: '#B8BFCA', changing: '#8C95A7', decommissioned: '#94a3b8' },
    },
    metaBox: { fill: '#ebebf5', stroke: '#aaaacc', text: '#444466' },
    group:   { fill: '#e8e8f5', stroke: '#9999bb', label: '#111111' },
  },
